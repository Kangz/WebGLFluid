...
glUtils.Texture = function(gl, options) {
    ...
    this.type = gl.textureType[options["type"] || "ubyte"];
...
glUtils.Texture.prototype = {
    ...
    dataFromCanvas: function(canvas) {
...
glUtils.createTextureFromCanvas = function (canvas, options) {
    return new this.Texture(this, options).dataFromCanvas(canvas);
}
